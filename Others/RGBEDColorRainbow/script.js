...
function randomColor() {
   ...
   color7 = "#" + letters[Math.floor(Math.random() * 16) - 1] + letters[Math.floor(Math.random() * 16) - 1] + letters[Math.floor(Math.random() * 16) - 1] + letters[Math.floor(Math.random() * 16) - 1] + letters[Math.floor(Math.random() * 16) - 1] + letters[Math.floor(Math.random() * 16) - 1]
   document.getElementById("text").innerHTML =
   '<span style="color:' + color1 + '">' + inputColor.value[0] + '</span>' + '<span style="color:' + color2 + '">' + inputColor.value[1] + '</span>' + '<span style="color:' + color3 + '">' + inputColor.value[2] + '</span>' + '<span style="color:' + color4 + '">' + inputColor.value[3] + '</span>' + '<span style="color:' + color5 + '">' + inputColor.value[4] + '</span>' + '<span style="color:' + color6 + '">' + inputColor.value[5] + '</span>' + '<span style="color:' + color7 + '">' + inputColor.value[6] + '</span>'
}
